...
<h1 class="gv-page-title" style="font-family:var(--gv-sans);font-size:1.5rem;margin-bottom:8px;">Paramètres</h1>

<div style="font-weight:700;font-size:1rem;margin-bottom:14px;color:#111;">Préférences</div>

<div style="background:#d9d9d9;border-radius:12px;padding:8px 0;max-width:560px;">
    <div style="display:flex;align-items:center;gap:16px;padding:16px 20px;border-bottom:1px solid #c4c4c4;">
...
<div style="text-align:center;margin-top:48px;font-size:0.8rem;color:#6b7280;">
    SIGECAR v1.0.0<br>
